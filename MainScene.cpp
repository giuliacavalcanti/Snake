...
void MainScene::drawGameScene() {
  ...
  //  this->bonusTimeLeftNumber->setVisible(false);
    ...
    gameScene->drawLevel(maps.at(1));
    gameScene->drawSnake(this->snakeHead.at(1));
    gameScene->startGame();
...
void MainScene::loadMaps() {
  ...
  /*  for (int i = 0;i<6;i++) {
    ...
    v1.append(QRect(0,nh-h,w,h));
    v1.append(QRect(w-h,0,h,nh));
    v1.append(QRect(150,50,5,10));
    maps.append(v1);
    maps.append(v1);
    maps.append(v1);
    maps.append(v1);
...
void MainScene::drawPreviews() {
    ...
    for (int i = 0;i<maps.length();i++) {
        ...
        this->v->append(new Preview(this->previewScenes->last()));
      ...
      //  QWidget* widget = new QWidget();
        ...
        for (int j = 0;j<maps.at(i).length();j++) {
            this->previewScenes->last()->addRect(maps.at(i).at(j),pen, brush);
        }
      ...
      //  QGraphicsProxyWidget* pr=this->addWidget(widget);
        ...
        QObject::connect(v->at(i),SIGNAL(clicked()),this,SLOT(drawGameScene()));
